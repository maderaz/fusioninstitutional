          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 40% 40%, #8429FF 5%, #8429FF00 15%),
                radial-gradient(circle at 60% 60%, #6C00FF 10%, #6C00FF00 20%), 
                radial-gradient(circle at 40% 60%, #6D28D9 10%, #6D28D900 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #a78bfa 0%,
                  #8429FF calc(25% / var(--repeating-conic-gradient-times)),
                  #6C00FF calc(50% / var(--repeating-conic-gradient-times)), 
